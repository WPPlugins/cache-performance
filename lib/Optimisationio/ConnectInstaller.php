<?php
/**
 * Optimisationio_ConnectInstaller
 *
 */
if (!defined('ABSPATH')) exit;
if( !class_exists('Optimisationio_ConnectInstaller') ) {
   class Optimisationio_ConnectInstaller {
            ...
            require_once( ABSPATH . 'wp-admin/includes/plugin-install.php' );
   		   foreach($plugins as $plugin) :
               ...
               //echo '</pre>';
	               ...
	               $main_plugin_file = Optimisationio_ConnectInstaller::get_plugin_file($plugin['slug']); // Get main plugin file
      ...
      */
		public function cnkt_plugin_activation(){
         ...
         // Include required libs for activation
			...
			if($api->name){
				$main_plugin_file = Optimisationio_ConnectInstaller::get_plugin_file($plugin);
				$status = 'success';
				if($main_plugin_file){
   ...
   // initialize
   $objinstaller = new Optimisationio_ConnectInstaller();
   $objinstaller->start();
 }  
...
global $optimisationio_db_version;
$optimisationio_db_version = "1.0";
...
function optimisationio_install()
{
    ...
    $sql = "CREATE TABLE IF NOT EXISTS " . $wpdb->prefix . 'wp_optimisation_sizes_info' . " (
    ...
    dbDelta($sql);
    add_option("optimisationio_db_version", $optimisationio_db_version);
    return true;
}
